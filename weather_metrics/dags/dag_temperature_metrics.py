...
from weather_metrics.operators.open_meteo import OpenMeteoMetricsOperator
from weather_metrics.utils.cities import CITIES
from weather_metrics.utils.temperature_helpers import INSERT_INTO_STMT
    ...
    for city in CITIES:
        ...
        with TaskGroup(group_id=f"process_{city_name}") as city_group:
            get_temperature_task = OpenMeteoMetricsOperator(
                ...
                metrics_mapper=dict(temperature_2m_max="max", temperature_2m_min="min"),
